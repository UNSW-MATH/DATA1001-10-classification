...
* You have learnt about classification problems, which are the basis for many 
  interesting data science problems 
* You know the basics of logistic regression, the standard tool for classification. 
  (As you become a data scientist, you'll get to know many more tools, e.g. 
